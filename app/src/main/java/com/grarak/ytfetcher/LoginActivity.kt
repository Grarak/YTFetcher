...
class LoginActivity : BaseActivity() {
    ...
    private lateinit var serverView: EditTextView
    private lateinit var usernameView: EditTextView
    private lateinit var passwordView: EditTextView
    private lateinit var confirmPasswordView: EditTextView
        ...
        findViewById<View>(R.id.done_btn).setOnClickListener {
            ...
            val userCallback = object : UserServer.UserCallback {
                ...
                override fun onFailure(code: Int) {
                    hideProgress()
                    when (code) {
                        Status.UserAlreadyExists -> Utils.toast(R.string.username_exists, this@LoginActivity)
                        Status.InvalidPassword -> Utils.toast(R.string.username_password_wrong, this@LoginActivity)
                        else -> Utils.toast(R.string.server_offline, this@LoginActivity)
                    }
                }
            }
